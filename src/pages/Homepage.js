...
const Homepage = () => {
    ...
    return (
        <div className='w-full bg-gray-700'>
            <div className='text-black flex flex-col items-center pl-64 pt-10 w-100'>
            ...
            <div className='flex justify-between pl-72 pt-10 text-black text-4xl font-bold'>
                <p>Top 10 Cryptocurrencies</p>
                <Link to="/cryptocurrencies" className='pr-8 text-2xl text-blue-800'>Show More</Link>
            </div>

            <Cryptocurrencies shortened />

            <div className='flex justify-between pl-72 pt-10 text-black text-4xl font-bold'>
                <p>Top 10 Exchanges</p>
                <Link to="/exchanges" className='pr-8 text-2xl text-blue-800'>Show More</Link>
            </div>

            <div className='flex justify-between pl-72 pt-10 text-black text-4xl font-bold'>
                <p>Top Mineable Coins</p>
                <Link to="/miningcrypto" className='pr-8 text-2xl text-blue-800'>Show More</Link>
            </div>

            <div className='flex justify-between pl-72 pt-10 text-black text-4xl font-bold'>
                <p>Top Crypto News</p>
                <Link to="/news" className='pr-8 text-2xl text-blue-800'>Show More</Link>
            </div>
        </div>
    );
};
